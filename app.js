(function () {
  ...
  const PORT_COORDS = {
    ...
    エディンバラ: port(-3.19, 55.95, "苏格兰", { label: "爱丁堡", alias: true }),
    オスロ: port(10.75, 59.91, "北欧", { label: "奥斯陆", alias: true }),
    コペンハーゲン: port(12.57, 55.68, "北欧", { label: "哥本哈根", alias: true }),
    ヨーテボリ: port(11.97, 57.71, "北欧", { label: "哥德堡", alias: true }),
    ベルゲン: port(5.32, 60.39, "北欧", { label: "卑尔根", alias: true }),
  ...
  const SEA_WAYPOINTS = {
    ...
    爱丁堡外海: seaPoint("爱丁堡外海", -2.15, 56.1),
    苏格兰东岸外海: seaPoint("苏格兰东岸外海", -0.5, 56.45),
    北海北部: seaPoint("北海北部", 2.7, 57.05),
    北海东北部: seaPoint("北海东北部", 5.9, 57.6),
    日德兰西南外海: seaPoint("日德兰西南外海", 6.5, 54.25),
    日德兰西岸外海: seaPoint("日德兰西岸外海", 7.2, 55.75),
    日德兰西北外海: seaPoint("日德兰西北外海", 8.15, 57.25),
    斯卡格拉克海峡: seaPoint("斯卡格拉克海峡", 9.8, 57.9),
    斯卡恩外海: seaPoint("斯卡恩外海", 10.7, 57.75),
    卡特加特北口: seaPoint("卡特加特北口", 11.15, 57.15),
    卡特加特海峡: seaPoint("卡特加特海峡", 11.35, 56.55),
    卡特加特南口: seaPoint("卡特加特南口", 11.85, 56.2),
    西兰北岸外海: seaPoint("西兰北岸外海", 12.28, 56.18),
    厄勒海峡北口: seaPoint("厄勒海峡北口", 12.65, 56.08),
    厄勒海峡: seaPoint("厄勒海峡", 12.68, 55.86),
    哥本哈根外海: seaPoint("哥本哈根外海", 12.72, 55.72),
  ...
  function formatPositionDetails(position) {
    ...
    if (calibrationNames.length) {
      ...
      parts.push(`船位已按${calibrationNames[0].replace("校准:", "")}校准${suffix}`);
    }
    return parts.join(" | ");
  }
